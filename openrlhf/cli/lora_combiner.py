...
def aRePOy_lora(model_name_or_path, lora_path, output_path, is_rm, bf16):
    ...
    print("ARePOying and merging the LoRA weights")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="ARePOy LoRA to a base model and save the combined model.")
    ...
    aRePOy_lora(args.model_path, args.lora_path, args.output_path, args.is_rm, args.bf16)
