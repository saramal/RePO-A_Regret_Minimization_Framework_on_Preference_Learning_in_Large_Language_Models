...
from openrlhf.datasets import RewardDataset, RePODataset, RePO_datasets, RePODataset_Deterministic_fast_simpo
from openrlhf.models import Actor
from openrlhf.trainer import RewardModelTrainer, RePOTrainerDeterministic
...
def train(args):
    ...
    if args.use_fast_dataset:
        train_dataset = RePODataset_Deterministic_fast_simpo(
            train_data,
            tokenizer,
            args.max_len,
            strategy,
    ...
    if eval_data is not None:
        ...
        if args.use_fast_dataset:
            eval_dataset = RePODataset_Deterministic_fast_simpo(
                eval_data,
                tokenizer,
                args.max_len,
                strategy,
    ...
    trainer = RePOTrainerDeterministic(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb_project", type=str, default="openrlhf_train_RePO_det")
    parser.add_argument(
        "--wandb_run_name",
        type=str,
        default="RePO",
