...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path", type=str, default="./checkpoint/ckpt/checkpoints_dpo")
    ...
    parser.add_argument("--beta", type=float, default=0.1, help="Temperature parameter for TDPO loss")
    parser.add_argument("--alpha", type=float, default=0.5, help="Temperature parameter for adjusting impact of sequential KL divergence in TDPO")
    parser.add_argument("--if_tdpo2", action="store_true", default=True, help="Use TDPO2 variant (default: True). If False, use TDPO1.")
    ...
    args.wandb_run_name = args.wandb_run_name + "_" + datetime.now().strftime("%Y%m%d_%H%M%S")
