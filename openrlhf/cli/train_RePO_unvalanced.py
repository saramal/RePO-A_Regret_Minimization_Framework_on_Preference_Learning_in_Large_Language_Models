...
from openrlhf.datasets import RewardDataset, RePODataset, RePO_datasets
from openrlhf.models import Actor
from openrlhf.trainer import RewardModelTrainer, RePOTrainer, RePO_Unbalanced_Trainer
...
def train(args):
    ...
    trainer = RePO_Unbalanced_Trainer(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--beta", type=float, default=0.1, help="beta for unvalanced RePO loss")
