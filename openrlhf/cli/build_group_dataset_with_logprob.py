            ...
            if chosen_key in obj:
                ...
                if chosen_text not in group["chosen"]:
                    if chosen_logprob_key in obj:
                        group["chosen"][chosen_text] = obj[chosen_logprob_key]
                    else:
            ...
            if rejected_key in obj:
                ...
                if rejected_text not in group["rejected"]:
                    if rejected_logprob_key in obj:
                        group["rejected"][rejected_text] = obj[rejected_logprob_key]
                    else:
    ...
    with open(output_path, "w", encoding="utf-8") as out_f:
        for prompt, group in tqdm(groups.items(), desc="Writing groups"):
            chosen_set = [
                {
                    "chosen": chosen_text,
                    "chosen_logprob_with_token": group["chosen"][chosen_text],
            ...
            rejected_set = [
                {
                    ...
                    "rejected_logprob_with_token": group["rejected"][rejected_text],
...
if __name__ == "__main__":
    ...
    output_file = "RePO_datasets/MetamathQA/logp_scored_qwen2.5-Math-7B-Instruct/portion_logprob_grouped.jsonl"
    max_samples = 64
    import os
