...
from openrlhf.datasets import UnpairedPreferenceDatasetForPairedDataset
...
def train(args):
    ...
    train_dataset = UnpairedPreferenceDatasetForPairedDataset(
        train_data, tokenizer, args.max_len, strategy, input_template=args.input_template
    )
    eval_dataset = UnpairedPreferenceDatasetForPairedDataset(
