...
from openrlhf.datasets import RewardDataset, RePODataset, RePO_datasets, RePODataset_Deterministic_fast
...
def train(args):
    ...
    if args.use_fast_dataset:
        train_dataset = RePODataset_Deterministic_fast(
            train_data,
            tokenizer,
            args.max_len,
            strategy,
    ...
    if eval_data is not None:
        ...
        if args.use_fast_dataset:
            eval_dataset = RePODataset_Deterministic_fast(
                eval_data,
                tokenizer,
                args.max_len,
                strategy,
