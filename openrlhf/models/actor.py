...
#TODO: for prm
from .utils_prm import log_probs_from_logits, reset_position_ids
...
class Actor(nn.Module):
    ...
    Args:
        ...
        target_modules (list, optional): List of target modules for aRePOying LoRA. Defaults to None.
    ...
    def generate(self, input_ids: torch.Tensor, **kwargs) -> Union[
        ...
        if kwargs.get("max_new_tokens", None):
            ...
            generate_args["max_new_tokens"] = None
            ...
            if ring_attn_group is not None:
                ...
                if attention_mask is not None:
                    ...
                    try:
                        ...
                        raise ValueError("attention_mask is required for packing_samples")
            # explicitly ignore attention_mask for packing_samples
            attention_mask = None
        if isinstance(sequences, list):
            # logger.info(f"LINE 236 sequences_BEFORE: {sequences}")
            sequences = torch.stack(sequences, dim=0)
            # logger.info(f"LINE 238 sequences_AFTER: {sequences}")
