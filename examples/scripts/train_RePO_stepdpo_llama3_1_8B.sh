...
deepspeed --module openrlhf.cli.train_RePO \
   --save_path ./checkpoint/Llama3.1-8B-stepdpo-RePO \
   --save_steps -1 \
   --logging_steps 1 \
   --eval_steps -2 \
   --train_batch_size 32 \
   --micro_train_batch_size 2 \
   --pretrain checkpoint/Llama3.1-8B-sft-stepdpo_0828T12:51_merged \
   --bf16 \
   --max_epochs 10 \
   --max_len 2048 \
   --zero_stage 2 \
   ...
   --sft_loss \
   --use_wandb \
   --wandb_run_name RePO_llama3.1-8B_stepdpo \
   --cpl_lambda 1 \
   --save_merged \
