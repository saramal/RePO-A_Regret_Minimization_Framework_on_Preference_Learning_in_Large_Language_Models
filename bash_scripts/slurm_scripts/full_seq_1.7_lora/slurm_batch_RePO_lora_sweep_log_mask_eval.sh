...
experiments=(
    ...
    "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_128_metamathqa_filtered_1120T02:06_merged 128 1 Qwen3-1.7B-logprob_pair 1 5e-7"
...
experiments=(
    "$MODEL_PATH RePO_Qwen3-1.7B-logprob_pair_lora_128_metamathqa_filtered"
...
experiments=(
    ...
    "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_128_metamathqa_filtered_1120T02:06_merged 128 1 Qwen3-1.7B-masked_pair 1 5e-7"
    # "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_128_metamathqa_filtered_1120T02:06_0.5_merged 128 1 Qwen3-1.7B-half_base_pair 1 5e-7"
...
experiments=(
    "$MODEL_PATH RePO_Qwen3-1.7B-masked_pair_lora_128_metamathqa_filtered"
