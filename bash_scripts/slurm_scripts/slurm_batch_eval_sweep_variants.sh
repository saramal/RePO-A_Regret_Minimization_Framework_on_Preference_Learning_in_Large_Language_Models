...
experiments=(
    ...
    "checkpoint/RePO_Qwen/RePO_det_det_Qwen3-1.7B-non_sft_base_pair_sft0.0_lora_32_alpha_1_lr_5e-7_metamathqa_1126T15:02_merged RePO_det_Qwen3-1.7B-non_sft_base_pair_sft0.0_lora_32_alpha_1_lr_5e-7_metamathqa"
