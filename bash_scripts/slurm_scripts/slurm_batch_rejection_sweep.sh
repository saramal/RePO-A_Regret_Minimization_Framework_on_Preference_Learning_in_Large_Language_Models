...
#SBATCH --job-name=rejection_sweep
...
experiments=(
    "checkpoint/sft_Qwen/Qwen3-8B-Base_lora_128_metamathqa_0920T03:38_merged 64 2 Qwen3-8B-Base"
    "checkpoint/sft_Qwen/Qwen3-4B-Base_lora_0_metamathqa_0921T04:45 32 2 Qwen3-4B-Base"
    "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_0_metamathqa_0924T05:22 32 4 Qwen3-1.7B-Base"
...
for experiment in "${experiments[@]}"; do
    ...
    bash   ./bash_scripts/train_scripts/train_rejection_sweep.sh \
        ...
        --dataset "RePO_datasets/MetamathQA/RePO/qwen2.5-Math-7B-Instruct_dist_batch_new/RePO_train.jsonl" \
        --input_key prompt \
        --output_key chosen \
        ...
        --use_wandb True \
        --input_template None \
        --wandb_run_name "rejection_${model_name_short}_lora_${lora_rank}_metamathqa" \
        --save_merged True
