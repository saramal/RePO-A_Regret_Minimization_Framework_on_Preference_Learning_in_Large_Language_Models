...
#SBATCH --job-name=RePO_mask_sweep
...
experiments=(
    "checkpoint/sft_Qwen/Qwen3-8B-Base_lora_128_metamathqa_0920T03:38_merged 128 1 Qwen3-8B-masked_pair 1 1e-7"
    "checkpoint/sft_Qwen/Qwen3-4B-Base_lora_0_metamathqa_0921T04:45 128 1 Qwen3-4B-masked_pair 1 1e-7"
    "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_0_metamathqa_0924T05:22 128 1 Qwen3-1.7B-masked_pair 1 1e-7"
...
for experiment in "${experiments[@]}"; do
    ...
    bash   ./bash_scripts/train_scripts/train_RePO_sweep.sh \
        ...
        --dataset RePO_datasets/MetamathQA/RePO/qwen2.5-Math-7B-Instruct/mask_pair/RePO_train.jsonl \
        --prompt_key prompt \
        --chosen_key chosen \
