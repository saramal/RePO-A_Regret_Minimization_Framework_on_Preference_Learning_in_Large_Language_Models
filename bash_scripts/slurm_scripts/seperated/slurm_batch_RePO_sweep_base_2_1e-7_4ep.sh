...
experiments=(
    ...
    # "checkpoint/sft_Qwen/Qwen3-8B-Base_lora_128_metamathqa_0920T03:38_merged 128 1 Qwen3-8B-base_pair 2 5e-7 2"
    "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_0_metamathqa_0924T05:22 128 4 Qwen3-1.7B-base_tune 2 1e-7 4"
