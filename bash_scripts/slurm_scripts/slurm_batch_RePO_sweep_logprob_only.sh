...
#SBATCH --job-name=RePO_logp_only_sweep
...
experiments=(
    "checkpoint/sft_Qwen/Qwen3-8B-Base_lora_128_metamathqa_0920T03:38_merged 128 1 Qwen3-8B-logprob_only 1 1e-7"
    "checkpoint/sft_Qwen/Qwen3-4B-Base_lora_0_metamathqa_0921T04:45 128 1 Qwen3-4B-logprob_only 1 1e-7"
    "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_0_metamathqa_0924T05:22 128 1 Qwen3-1.7B-logprob_only 1 1e-7"
...
for experiment in "${experiments[@]}"; do
    ...
    bash   ./bash_scripts/train_scripts/train_RePO_sweep.sh \
        ...
        --dataset RePO_datasets/MetamathQA/RePO/qwen2.5-Math-7B-Instruct/logscore_pair_chosen_only/RePO_train.jsonl \
        --prompt_key prompt \
        --chosen_key chosen \
        ...
        --use_wandb True \
        --input_template None \
        --wandb_run_name "RePO_${model_name_short}_lora_${lora_rank}_alpha_${alpha}_lr_${learning_rate}_metamathqa" \
        --save_merged
