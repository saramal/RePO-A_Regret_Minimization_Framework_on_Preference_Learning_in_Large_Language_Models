...
# )
experiments=(
    "checkpoint/rejection_Qwen3-1.7B-Base_lora_32_metamathqa_1015T05:44_merged rej_Qwen3-1.7B-Base_lora_32_metamathqa"
    "checkpoint/rejection_Qwen3-4B-Base_lora_32_metamathqa_1014T09:23_merged rej_Qwen3-4B-Base_lora_32_metamathqa"
    "checkpoint/rejection_Qwen3-8B-Base_lora_64_metamathqa_1013T02:57_merged rej_Qwen3-8B-Base_lora_64_metamathqa"
