...
experiments=(
    ...
    "checkpoint/RePO_Qwen/RePO_det_Qwen3-1.7B-non_sft_base_pair_sft0.0_cpl0.5_lora_32_alpha_1_lr_5e-7_metamathqa_1213T00:50_merged RePO_det_Qwen3-1.7B-non_sft_base_pair_sft0.0_cpl0.5_lora_32_alpha_1_lr_5e-7_metamathqa"
    ...
    "checkpoint/RePO_Qwen/RePO_det_Qwen3-4B-non_sft_base_pair_sft0.0_cpl0.5_lora_32_alpha_1_lr_5e-7_metamathqa_1213T04:08_merged RePO_det_Qwen3-4B-non_sft_base_pair_sft0.0_cpl0.5_lora_32_alpha_1_lr_5e-7_metamathqa"
    ...
    "checkpoint/dpo_Qwen3-8B-non_sft_base_pair_sft0.0_lora_64_metamathqa_filtered_1212T14:48_merged dpo_Qwen3-8B-non_sft_base_pair_sft0.0_lora_64_metamathqa_filtered"
    "checkpoint/RePO_Qwen/RePO_det_Qwen3-8B-non_sft_base_pair_sft0.0_cpl0.5_lora_64_alpha_1_lr_5e-7_metamathqa_1211T20:03_merged RePO_det_Qwen3-8B-non_sft_base_pair_sft0.0_cpl0.5_lora_64_alpha_1_lr_5e-7_metamathqa"
    "checkpoint/RePO_Qwen/RePO_Qwen3-8B-non_sft_base_pair_sft0.0_cpl0.5_lora_64_alpha_1_lr_5e-7_metamathqa_1211T10:04_merged RePO_Qwen3-8B-non_sft_base_pair_sft0.0_cpl0.5_lora_64_alpha_1_lr_5e-7_metamathqa"
...
for experiment in "${experiments[@]}"; do
    ...
    bash   ./bash_scripts/eval_scripts/eval_math_benchmarks_vllm_dist.sh \
        ...
        --result_txt_path evaluation_results_txt/math_results_extended_pass_1.txt \
        --dataset ./evaluation/eval_data_extended/ \
        --tp_size 1 \
        --max_len 2048 \
        --top_p 1.0 \
        --temperature 0.0 \
