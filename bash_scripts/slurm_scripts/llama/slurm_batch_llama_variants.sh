...
#     "meta-llama/Llama-3.1-8B-Instruct 64 2 llama3.1-8B-Instruct_metamathqa_filtered 1 5e-7"
#     # "meta-llama/Llama-3.1-8B 64 2 llama3.1-8B-Base_metamathqa_filtered 1 5e-7"
...
#     learning_rate=${experiment_array[5]}
#     echo "########################################################"
#     echo "Running experiment: RePO_DET - ${model_name_short} with lora rank ${lora_rank}"
#     echo "########################################################"

#     bash   ./bash_scripts/train_scripts/train_RePO_det_sweep.sh \
#         --pretrain $model_name \
#         --save_path ./checkpoint/RePO_llama/RePO_det_${model_name_short}_lora_${lora_rank}_alpha_${alpha}_lr_${learning_rate}_metamathqa \
#         --ckpt_path ./checkpoint/ckpt/RePO_llama/RePO_det_${model_name_short}_lora_${lora_rank}_alpha_${alpha}_lr_${learning_rate}_metamathqa \
#         --dataset RePO_datasets/MetamathQA/RePO/qwen2.5-Math-7B-Instruct/basic_pair/RePO_train.jsonl \
#         --prompt_key prompt \
#         --chosen_key chosen \
#         --rejected_key rejected \
...
#         --use_wandb \
#         --input_template None \
#         --wandb_run_name "RePO_det_${model_name_short}_lora_${lora_rank}_alpha_${alpha}_metamathqa" \
#         --save_merged
...
# experiments=(
#     "$MODEL_PATH RePO_det_llama3.1-8B-Instruct_metamathqa_filtered_lora_64_metamathqa_filtered"
...
# experiments=(
#     "$MODEL_PATH dpo_llama3.1-8B-Instruct_metamathqa_filtered_lora_64_metamathqa_filtered"
...
for experiment in "${experiments[@]}"; do
    ...
    bash   ./bash_scripts/train_scripts/train_rpo_sweep.sh \
        ...
        --ckpt_path ./checkpoint/ckpt/rpo_${model_name_short}_lora_${lora_rank}_metamathqa_filtered \
        --dataset RePO_datasets/MetamathQA/RePO/qwen2.5-Math-7B-Instruct/basic_pair/RePO_train.jsonl \
        --prompt_key prompt \
        --chosen_key chosen \
        --rejected_key rejected \
...
experiments=(
    "$MODEL_PATH rpo_llama3.1-8B-Base_metamathqa_filtered_2e-5_lora_64_metamathqa_filtered"
...
for experiment in "${experiments[@]}"; do
    ...
    bash   ./bash_scripts/train_scripts/train_ipo_sweep.sh \
        ...
        --ckpt_path ./checkpoint/ckpt/ipo_${model_name_short}_lora_${lora_rank}_metamathqa_filtered \
        --dataset RePO_datasets/MetamathQA/RePO/qwen2.5-Math-7B-Instruct/basic_pair/RePO_train.jsonl \
        --prompt_key prompt \
        --chosen_key chosen \
        --rejected_key rejected \
...
experiments=(
    "$MODEL_PATH ipo_llama3.1-8B-Base_metamathqa_filtered_2e-5_lora_64_metamathqa_filtered"
...
for experiment in "${experiments[@]}"; do
    ...
    bash   ./bash_scripts/train_scripts/train_tdpo_sweep.sh \
        ...
        --ckpt_path ./checkpoint/ckpt/tdpo_${model_name_short}_lora_${lora_rank}_metamathqa_filtered \
        --dataset RePO_datasets/MetamathQA/RePO/qwen2.5-Math-7B-Instruct/basic_pair/RePO_train.jsonl \
        --prompt_key prompt \
        --chosen_key chosen \
        --rejected_key rejected \
...
experiments=(
    "$MODEL_PATH tdpo_llama3.1-8B-Base_metamathqa_filtered_2e-5_lora_64_metamathqa_filtered"
...
experiments=(
    "$MODEL_PATH kto_llama3.1-8B-Base_metamathqa_filtered_2e-5_lora_64_metamathqa_filtered"
...
for experiment in "${experiments[@]}"; do
    ...
    bash   ./bash_scripts/train_scripts/train_simpo_sweep.sh \
        --pretrain $model_name \
        --save_path ./checkpoint/simpo_${model_name_short}_lora_${lora_rank}_metamathqa_filtered \
        --ckpt_path ./checkpoint/ckpt/simpo_${model_name_short}_lora_${lora_rank}_metamathqa_filtered \
        --dataset RePO_datasets/MetamathQA/RePO/qwen2.5-Math-7B-Instruct/basic_pair/RePO_train.jsonl \
        --prompt_key prompt \
        --chosen_key chosen \
        --rejected_key rejected \
        ...
        --use_wandb \
        --input_template None \
        --wandb_run_name "simpo_${model_name_short}_lora_${lora_rank}_metamathqa_filtered" \
        --save_merged
...
experiments=(
    "$MODEL_PATH simpo_llama3.1-8B-Base_metamathqa_filtered_2e-5_lora_64_metamathqa_filtered"
...
experiments=(
    "$MODEL_PATH rpo_llama3.1-8B-Instruct_metamathqa_filtered_5e-6_lora_64_metamathqa_filtered"
...
experiments=(
    "$MODEL_PATH ipo_llama3.1-8B-Instruct_metamathqa_filtered_5e-6_lora_64_metamathqa_filtered"
...
experiments=(
    "$MODEL_PATH tdpo_llama3.1-8B-Instruct_metamathqa_filtered_5e-6_lora_64_metamathqa_filtered"
...
experiments=(
    "$MODEL_PATH kto_llama3.1-8B-Instruct_metamathqa_filtered_5e-6_lora_64_metamathqa_filtered"
...
experiments=(
    "$MODEL_PATH simpo_llama3.1-8B-Instruct_metamathqa_filtered_5e-6_lora_64_metamathqa_filtered"
...
# experiments=(
#     "$MODEL_PATH RePO_det_llama3.1-8B-Base_metamathqa_filtered_lora_64_metamathqa_filtered"
...
#     "meta-llama/Llama-3.1-8B-Instruct 64 1 llama3.1-8B-Instruct_metamathqa_filtered 1 5e-7"
#     # "meta-llama/Llama-3.1-8B 64 1 llama3.1-8B-Base_metamathqa_filtered 1 5e-7"
