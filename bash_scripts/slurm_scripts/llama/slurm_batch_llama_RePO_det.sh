...
experiments=(
    ...
    "meta-llama/Llama-3.1-8B 64 2 llama3.1-8B-Base_metamathqa_filtered_5e-6 1 5e-6"
...
experiments=(
    ...
    "meta-llama/Llama-3.1-8B-Instruct 64 2 llama3.1-8B-Instruct_metamathqa_filtered_5e-6 1 5e-6"
