...
#     "Qwen/Qwen3-4B-Base 64 1 Qwen3-4B-base_sft0.0 1 2e-5"
...
experiments=(
    ...
    "Qwen/Qwen3-4B-Base 64 1 Qwen3-4B-Base_uf_custom_4epochs_2e-5"
...
for experiment in "${experiments[@]}"; do
    ...
    bash   ./bash_scripts/train_scripts/train_dpo_sweep.sh \
        ...
        --ckpt_path ./checkpoint/ckpt/dpo_Qwen/dpo_${model_name_short}_lora_${lora_rank}_ultrafeedback_custom \
        --dataset "RePO_datasets/Ultrafeedback/biniarized/RePO_train_biniarized_cleaned.jsonl, RePO_datasets/Ultrafeedback/biniarized/RePO_test_Qwen2.5-14B-Instruct.jsonl" \
        --disable_ds_ckpt \
        --save_hf_ckpt \
        --prompt_key prompt \
...
#     "Qwen/Qwen3-1.7B-Base 32 1 Qwen3-1.7B-Base_sft0.0_cpl0.5_2epochs 1 5e-7"
