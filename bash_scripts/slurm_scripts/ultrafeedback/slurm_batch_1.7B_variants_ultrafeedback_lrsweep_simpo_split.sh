...
#     "Qwen/Qwen3-1.7B-Base 32 2 Qwen3-1.7B-Base_uf_custom_4epochs_2e-5"
...
# experiments=(
#     "Qwen/Qwen3-1.7B-Base 32 2 Qwen3-1.7B-Base_uf_custom_4epochs_1e-6"
...
#         --ckpt_path ./checkpoint/ckpt/tdpo_Qwen/tdpo_${model_name_short}_lora_${lora_rank}_ultrafeedback_custom \
#         --dataset "RePO_datasets/Ultrafeedback/biniarized/RePO_train_biniarized_cleaned.jsonl, RePO_datasets/Ultrafeedback/biniarized/RePO_test_Qwen2.5-14B-Instruct.jsonl" \
#         --prompt_key prompt \
#         --chosen_key chosen \
#         --rejected_key rejected \
...
# experiments=(
#     "Qwen/Qwen3-1.7B-Base 32 2 Qwen3-1.7B-Base_uf_custom_2epochs_2e-5"
...
#         --ckpt_path ./checkpoint/ckpt/rpo_Qwen/rpo_${model_name_short}_lora_${lora_rank}_ultrafeedback_custom \
#         --dataset "RePO_datasets/Ultrafeedback/biniarized/RePO_train_biniarized_cleaned.jsonl, RePO_datasets/Ultrafeedback/biniarized/RePO_test_Qwen2.5-14B-Instruct.jsonl" \
#         --prompt_key prompt \
#         --chosen_key chosen \
#         --rejected_key rejected \
...
#         --ckpt_path ./checkpoint/ckpt/ipo_Qwen/ipo_${model_name_short}_lora_${lora_rank}_ultrafeedback_custom \
#         --dataset "RePO_datasets/Ultrafeedback/biniarized/RePO_train_biniarized_cleaned.jsonl, RePO_datasets/Ultrafeedback/biniarized/RePO_test_Qwen2.5-14B-Instruct.jsonl" \
#         --prompt_key prompt \
#         --chosen_key chosen \
#         --rejected_key rejected \
...
experiments=(
    "Qwen/Qwen3-1.7B-Base 32 2 Qwen3-1.7B-Base_uf_custom_2epochs_5e-7"
...
for experiment in "${experiments[@]}"; do
    ...
    bash   ./bash_scripts/train_scripts/train_simpo_sweep.sh \
        ...
        --ckpt_path ./checkpoint/ckpt/simpo_Qwen/simpo_${model_name_short}_lora_${lora_rank}_ultrafeedback_custom \
        --dataset "RePO_datasets/Ultrafeedback/biniarized/RePO_train_biniarized_cleaned.jsonl, RePO_datasets/Ultrafeedback/biniarized/RePO_test_Qwen2.5-14B-Instruct.jsonl" \
        --prompt_key prompt \
        --chosen_key chosen \
        --rejected_key rejected \
...
#         --ckpt_path ./checkpoint/ckpt/kto_Qwen/kto_${model_name_short}_lora_${lora_rank}_ultrafeedback_custom \
#         --dataset "RePO_datasets/Ultrafeedback/biniarized/RePO_train_biniarized_cleaned.jsonl, RePO_datasets/Ultrafeedback/biniarized/RePO_test_Qwen2.5-14B-Instruct.jsonl" \
#         --prompt_key prompt \
#         --chosen_key chosen \
#         --rejected_key rejected \
...
#     "Qwen/Qwen3-1.7B-Base 32 2 Qwen3-1.7B-Base_sft0.0_cpl0.5_4epochs 1 2e-5"
...
#     "Qwen/Qwen3-1.7B-Base 32 1 Qwen3-1.7B-Base_sft0.0_cpl0.5_4epochs 1 2e-5"
...
# bash bash_scripts/slurm_scripts/ultrafeedback/slurm_batch_4B_variants_ultrafeedback.sh
