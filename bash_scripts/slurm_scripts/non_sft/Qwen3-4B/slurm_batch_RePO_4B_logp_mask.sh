...
#     "Qwen/Qwen3-4B-Base 32 2 Qwen3-4B-non_sft_logprob_pair_sft0.0_cpl0.5 1 5e-7"
...
# experiments=(
#     "$MODEL_PATH RePO_Qwen3-4B-non_sft_logprob_pair_sft0.0_cpl0.5_lora_32_metamathqa_filtered"
...
# experiments=(
#     "Qwen/Qwen3-4B-Base 32 2 Qwen3-4B-non_sft_logprob_pair"
...
# experiments=(
#     "$MODEL_PATH dpo_Qwen3-4B-non_sft_logprob_pair_lora_32_metamathqa_filtered"
...
experiments=(
    ...
    "Qwen/Qwen3-4B-Base 32 2 Qwen3-4B-non_sft_masked_pair_sft0.0_cpl0.5 1 5e-7"
    # "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_128_metamathqa_filtered_1120T02:06_0.5_merged 128 1 Qwen3-1.7B-half_base_pair 1 5e-7"
...
experiments=(
    "$MODEL_PATH RePO_Qwen3-4B-non_sft_masked_pair_sft0.0_cpl0.5_lora_32_metamathqa_filtered"
...
experiments=(
    "Qwen/Qwen3-4B-Base 32 2 Qwen3-4B-non_sft_masked_pair"
...
experiments=(
    "$MODEL_PATH dpo_Qwen3-4B-non_sft_masked_pair_lora_32_metamathqa_filtered"
