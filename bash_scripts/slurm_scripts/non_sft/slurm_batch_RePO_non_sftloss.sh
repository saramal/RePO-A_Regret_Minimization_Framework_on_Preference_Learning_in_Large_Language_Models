...
experiments=(
    ...
    "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_128_metamathqa_filtered_1120T02:06_merged 32 1 Qwen3-1.7B-base_pair_nosft 1 5e-7"
...
experiments=(
    "$MODEL_PATH RePO_Qwen3-1.7B-base_pair_nosft_lora_32_metamathqa_filtered"
