...
experiments=(
    ...
    # "checkpoint/sft_Qwen/Qwen3-4B-Base_lora_0_metamathqa_0924T05:22 128 2 Qwen3-4B-base_pair 1 1e-7"
    
    "Qwen/Qwen3-4B-Base 64 2 Qwen3-4B-Base_2epochs_5e-6 1 5e-6"
    # "checkpoint/sft_Qwen/Qwen3-4B-Base_lora_128_metamathqa_filtered_1120T02:06_0.5_merged 128 1 Qwen3-4B-half_base_pair 1 5e-7"
...
experiments=(
    "$MODEL_PATH RePO_Qwen3-4B-Base_2epochs_5e-6_lora_32_metamathqa_filtered"
...
experiments=(
    "Qwen/Qwen3-4B-Base 64 2 Qwen3-4B-Base_2epochs_5e-6"
...
experiments=(
    "$MODEL_PATH dpo_Qwen3-4B-Base_2epochs_5e-6_lora_32_metamathqa_filtered"
...
experiments=(
    "$MODEL_PATH RePO_det_Qwen3-4B-Base_2epochs_5e-6_lora_64_metamathqa_filtered"
...
experiments=(
    "$MODEL_PATH kto_Qwen3-4B-Base_2epochs_5e-6_lora_64_metamathqa_filtered"
...
experiments=(
    "Qwen/Qwen3-4B-Base 32 2 Qwen3-4B-Base_2epochs_2e-5"
...
experiments=(
    "$MODEL_PATH tdpo_Qwen3-4B-Base_2epochs_5e-6_lora_64_metamathqa_filtered"
...
experiments=(
    "$MODEL_PATH rpo_Qwen3-4B-Base_2epochs_5e-6_lora_64_metamathqa_filtered"
...
experiments=(
    "$MODEL_PATH ipo_Qwen3-4B-Base_2epochs_5e-6_lora_64_metamathqa_filtered"
...
experiments=(
    "$MODEL_PATH simpo_Qwen3-4B-Base_2epochs_5e-6_lora_64_metamathqa_filtered"
