...
experiments=(
    ...
    "Qwen/Qwen3-8B-Base 64 2 Qwen3-8B-non_sft_base_pair_sft0.0_cpl0.0 1 5e-7"
...
experiments=(
    "$MODEL_PATH RePO_Qwen3-8B-non_sft_base_pair_sft0.0_cpl0.0_lora_64_metamathqa_filtered"
