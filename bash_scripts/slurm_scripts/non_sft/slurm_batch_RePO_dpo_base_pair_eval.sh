...
experiments=(
    ...
    "Qwen/Qwen3-1.7B-Base 32 1 det_Qwen3-1.7B-non_sft_base_pair_sft0.0 1 5e-7"
...
for experiment in "${experiments[@]}"; do
    ...
    bash   ./bash_scripts/train_scripts/train_RePO_det_sweep.sh \
        --pretrain $model_name \
        --save_path ./checkpoint/RePO_Qwen/RePO_det_${model_name_short}_lora_${lora_rank}_alpha_${alpha}_lr_${learning_rate}_metamathqa \
        --ckpt_path ./checkpoint/ckpt/RePO_Qwen/RePO_det_${model_name_short}_lora_${lora_rank}_alpha_${alpha}_lr_${learning_rate}_metamathqa \
...
experiments=(
    "$MODEL_PATH RePO_det_Qwen3-1.7B-non_sft_base_pair_sft0.0_lora_32_metamathqa_filtered"
...
experiments=(
    ...
    "Qwen/Qwen3-1.7B-Base 32 1 det_Qwen3-1.7B-non_sft_base_pair_sft0.5 1 5e-7"
    # "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_128_metamathqa_filtered_1120T02:06_0.5_merged 128 1 Qwen3-1.7B-half_base_pair 1 5e-7"
...
experiments=(
    "$MODEL_PATH RePO_det_Qwen3-1.7B-non_sft_base_pair_sft0.5_lora_32_metamathqa_filtered"
