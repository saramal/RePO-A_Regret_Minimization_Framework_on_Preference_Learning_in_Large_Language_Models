...
experiments=(
    ...
    "Qwen/Qwen3-1.7B-Base 64 1 Qwen3-1.7B-non_sft_base_pair_sft0.0_tiny 1 5e-7"
...
experiments=(
    "$MODEL_PATH RePO_Qwen3-1.7B-non_sft_base_pair_sft0.0_tiny_lora_64_metamathqa_filtered"
...
experiments=(
    "Qwen/Qwen3-1.7B-Base 64 1 Qwen3-1.7B-non_sft_base_pair_sft0.0_tiny"
...
experiments=(
    "$MODEL_PATH dpo_Qwen3-1.7B-non_sft_base_pair_tiny_lora_64_metamathqa_filtered"
...
experiments=(
    ...
    "Qwen/Qwen3-1.7B-Base 64 1 Qwen3-1.7B-non_sft_base_pair_tiny"
    # "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_128_metamathqa_filtered_1120T02:06_0.5_merged 128 1 Qwen3-1.7B-half_base_pair 1 5e-7"
...
experiments=(
    "$MODEL_PATH rejection_Qwen3-1.7B-non_sft_base_pair_tiny_lora_64_metamathqa_filtered"
