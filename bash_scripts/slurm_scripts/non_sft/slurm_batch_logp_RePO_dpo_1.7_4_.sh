...
experiments=(
    ...
    "Qwen/Qwen3-1.7B-Base 32 2 Qwen3-1.7B-non_sft_logscore_pair_sft0.0_cpl0.5 1 5e-7"
...
for experiment in "${experiments[@]}"; do
    ...
    bash   ./bash_scripts/train_scripts/train_RePO_sweep.sh \
        ...
        --dataset RePO_datasets/MetamathQA/RePO/qwen2.5-Math-7B-Instruct/logscore_pair_extended/RePO_train.jsonl \
        --prompt_key prompt \
        --chosen_key chosen \
...
experiments=(
    "$MODEL_PATH RePO_Qwen3-1.7B-non_sft_logscore_pair_sft0.0_cpl0.5_lora_32_metamathqa_filtered"
...
experiments=(
    "Qwen/Qwen3-1.7B-Base 32 2 Qwen3-1.7B-non_sft_logscore_pair"
...
experiments=(
    "$MODEL_PATH dpo_Qwen3-1.7B-non_sft_logscore_pair_lora_32_metamathqa_filtered"
...
experiments=(
    ...
    "Qwen/Qwen3-4B-Base 32 1 Qwen3-4B-non_sft_logscore_pair_sft0.0_cpl0.5 1 5e-7"
    # "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_128_metamathqa_filtered_1120T02:06_0.5_merged 128 1 Qwen3-1.7B-half_base_pair 1 5e-7"
...
experiments=(
    "$MODEL_PATH RePO_Qwen3-4B-non_sft_logscore_pair_sft0.0_cpl0.5_lora_32_metamathqa_filtered"
...
experiments=(
    "Qwen/Qwen3-4B-Base 32 1 Qwen3-4B-non_sft_logscore_pair"
...
experiments=(
    "$MODEL_PATH dpo_Qwen3-4B-non_sft_logscore_pair_lora_32_metamathqa_filtered"
...
#     "Qwen/Qwen3-1.7B-Base 32 2 Qwen3-1.7B-non_sft_base_pair_sft0.0_cpl0.5 1 5e-7"
#     # "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_128_metamathqa_filtered_1120T02:06_0.5_merged 128 1 Qwen3-1.7B-half_base_pair 1 5e-7"
...
# experiments=(
#     "$MODEL_PATH RePO_Qwen3-1.7B-non_sft_base_pair_sft0.0_cpl0.5_lora_32_metamathqa_filtered"
...
#     "Qwen/Qwen3-4B-Base 32 2 Qwen3-4B-non_sft_base_pair_sft0.0_cpl0.5 1 5e-7"
#     # "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_128_metamathqa_filtered_1120T02:06_0.5_merged 128 1 Qwen3-1.7B-half_base_pair 1 5e-7"
