...
experiments=(
    ...
    "Qwen/Qwen3-1.7B-Base 32 4 Qwen3-1.7B-Base_2epochs_5e-6 1 5e-6"
...
experiments=(
    "$MODEL_PATH RePO_Qwen3-1.7B-Base_2epochs_2e-5_lora_32_metamathqa_filtered"
...
# experiments=(
#     "Qwen/Qwen3-1.7B-Base 32 2 Qwen3-1.7B-Base_2epochs_2e-5"
...
# experiments=(
#     "$MODEL_PATH dpo_Qwen3-1.7B-Base_2epochs_2e-5_lora_32_metamathqa_filtered"
...
#     "Qwen/Qwen3-1.7B-Base 32 2 Qwen3-1.7B-Base_2epochs_2e-5 1 2e-5"
...
# experiments=(
#     "$MODEL_PATH RePO_det_Qwen3-1.7B-Base_2epochs_2e-5_lora_32_metamathqa_filtered"
...
# experiments=(
#     "$MODEL_PATH kto_Qwen3-1.7B-Base_2epochs_2e-5_lora_32_metamathqa_filtered"
...
# experiments=(
#     "$MODEL_PATH tdpo_Qwen3-1.7B-Base_2epochs_2e-5_lora_32_metamathqa_filtered"
...
# experiments=(
#     "$MODEL_PATH rpo_Qwen3-1.7B-Base_2epochs_2e-5_lora_32_metamathqa_filtered"
...
# experiments=(
#     "$MODEL_PATH ipo_Qwen3-1.7B-non_sft_base_pair_lora_32_metamathqa_filtered"
...
# experiments=(
#     "$MODEL_PATH simpo_Qwen3-1.7B-Base_2epochs_2e-5_lora_32_metamathqa_filtered"
