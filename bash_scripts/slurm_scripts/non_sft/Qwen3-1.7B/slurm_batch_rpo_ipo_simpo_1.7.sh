...
#     "Qwen/Qwen3-8B-Base 64 2 Qwen3-8B-non_sft_base_pair_sft0.0_cpl0.5 1 5e-7"
...
# experiments=(
#     "$MODEL_PATH RePO_Qwen3-8B-non_sft_base_pair_sft0.0_cpl0.5_lora_64_metamathqa_filtered"
...
experiments=(
    "Qwen/Qwen3-1.7B-Base 32 2 Qwen3-1.7B-non_sft_base_pair"
...
experiments=(
    "$MODEL_PATH rpo_Qwen3-1.7B-non_sft_base_pair_lora_32_metamathqa_filtered"
...
experiments=(
    "$MODEL_PATH simpo_Qwen3-1.7B-non_sft_base_pair_lora_32_metamathqa_filtered"
