...
#SBATCH --job-name=RePO_logp_tune
...
experiments=(
    "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_0_metamathqa_0924T05:22 128 1 Qwen3-1.7B-logprob_tune 1 5e-7 2"
    "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_0_metamathqa_0924T05:22 128 1 Qwen3-1.7B-logprob_tune 2 3e-7 2"
    "checkpoint/sft_Qwen/Qwen3-1.7B-Base_lora_0_metamathqa_0924T05:22 128 1 Qwen3-1.7B-logprob_tune 1 5e-7 4"

    "checkpoint/sft_Qwen/Qwen3-8B-Base_lora_128_metamathqa_0920T03:38_merged 128 1 Qwen3-8B-logprob_tune 2 3e-7 2"
    "checkpoint/sft_Qwen/Qwen3-8B-Base_lora_128_metamathqa_0920T03:38_merged 128 1 Qwen3-8B-logprob_tune 2 5e-7 2"
    "checkpoint/sft_Qwen/Qwen3-8B-Base_lora_128_metamathqa_0920T03:38_merged 128 1 Qwen3-8B-logprob_tune 2 1e-7 4"
...
for experiment in "${experiments[@]}"; do
    ...
    bash   ./bash_scripts/train_scripts/train_RePO_sweep.sh \
        --pretrain $model_name \
        --save_path ./checkpoint/RePO_Qwen/RePO_${model_name_short}_lora_${lora_rank}_alpha_${alpha}_lr_${learning_rate}_epochs_${epochs}_metamathqa \
        ...
        --use_wandb True \
        --input_template None \
        --wandb_run_name "RePO_${model_name_short}_lora_${lora_rank}_alpha_${alpha}_lr_${learning_rate}_epochs_${epochs}_metamathqa" \
        --save_merged
